...
- **Multi-Exchange Support** — Trade across [Pacifica](reference/glossary.md#pacifica), [Hyperliquid](reference/glossary.md#extended), and more
...
<tbody>
<tr><td><i class="fa-seedling">:seedling:</i> <strong>New to Arbital?</strong><br>Start here — connect wallet, create your first bot, learn the basics</td><td><a href="getting-started/quick-start.md">quick-start.md</a></td></tr>
<tr><td><i class="fa-chart-line">:chart-line:</i> <strong>Experienced Trader</strong><br>Dive into strategies, advanced configuration, and optimization</td><td><a href="guides/bot-configuration.md">bot-configuration.md</a></td></tr>
<tr><td><i class="fa-code">:code:</i> <strong>Developer</strong><br>API reference, webhooks, and programmatic integration</td><td><a href="reference/api.md">api.md</a></td></tr>
</tbody>
</table>
...
|------|------------|--------------|----------|
| <i class="fa-seedling">:seedling:</i> **New User** | [Quick Start](getting-started/quick-start.md) | [Connect Wallet](getting-started/connect-wallet.md) | [Create First Bot](getting-started/create-first-bot.md) |
| <i class="fa-chart-line">:chart-line:</i> **Trader** | [Bot Configuration](guides/bot-configuration.md) | [Grid Strategy](guides/grid-strategy.md) | [Risk Management](guides/risk-management.md) |
| <i class="fa-code">:code:</i> **Developer** | [API Reference](reference/api.md) | [Glossary](reference/glossary.md) | Webhooks (coming soon) |
...
<thead><tr><th></th><th data-hidden data-card-target data-type="content-ref"></th></tr></thead>
<tbody>
<tr><td><i class="fa-rocket">:rocket:</i> <strong>Create Your First Bot</strong><br>Get started in under 10 minutes</td><td><a href="getting-started/create-first-bot.md">create-first-bot.md</a></td></tr>
<tr><td><i class="fa-link">:link:</i> <strong>Connect Wallet</strong><br>Link your Web3 wallet securely</td><td><a href="getting-started/connect-wallet.md">connect-wallet.md</a></td></tr>
<tr><td><i class="fa-chart-bar">:chart-bar:</i> <strong>Supported Exchanges</strong><br>Pacifica, Hyperliquid & more</td><td><a href="exchanges/overview.md">overview.md</a></td></tr>
<tr><td><i class="fa-book">:book:</i> <strong>API Reference</strong><br>Integrate programmatically</td><td><a href="reference/api.md">api.md</a></td></tr>
</tbody>
</table>
